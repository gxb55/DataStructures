...
/**
 * @ClassName AVLTree @Author guoxiaobing @Date 2020/9/16 14:24 @Version 1.0 @Description avl树
 * 二叉排序平衡树
 */
...
class Node {
  ...
  /**
   * 左旋代码，左旋完还是一个avl树 分为以下六步 A新增的结点；B 就是root节点 1.Node A = new Node(b.val); //新增一个节点值是根节点的值 2. a.left
   * = b.left //将b节点的左子树赋给新增节点 3.a.right = b.right.left // 将b节点的右子树的左子树赋给新增节点的右子树 4.b.val =
   * b.right.val // 将b节点右节点的值赋给b节点 5.b.right=b.right.right //将b的右节点的值设置为b的右节点的右节点 6.b.left = a//
   * 将新增的节点作为b的左子树
   */
